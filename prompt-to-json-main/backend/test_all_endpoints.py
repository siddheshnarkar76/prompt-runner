...
class APITester:
    ...
    async def run_all_tests(self):
        ...
        switch_data = {
            "user_id": "test_user",
            "spec_id": self.spec_id or "test_spec",
            "target": {"object_id": "kitchen_floor"},
            "update": {"material": "marble", "color_hex": "#FFFFFF"},
            "note": "Changed to marble",
        }
        ...
        city_rl_data = {
            "city": "Mumbai",
            "design_spec": {"type": "kitchen"},
            "user_rating": 4.5,
            "compliance_result": {"compliant": True},
        }
        await self.test_endpoint("POST", "/api/v1/rl/feedback/city", data=city_rl_data)

        print("\n🤖 Testing BHIV AI Assistant")
        print("-" * 40)

        # 14. BHIV AI Assistant (6 endpoints)
